...
LBracket    :: { LBracket} : L_LBracket { LBracket (mkPosToken $1)}
RBracket    :: { RBracket} : L_RBracket { RBracket (mkPosToken $1)}
LSquareBracket    :: { LSquareBracket} : L_LSquareBracket { LSquareBracket (mkPosToken $1)}
