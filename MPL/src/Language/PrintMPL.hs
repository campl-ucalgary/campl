...
instance Print MplType where
  prt i e = case e of
    ...
    MPL_UIDENT_ARGS_TYPE uident lbracket mpltypes rbracket -> prPrec i 2 (concatD [prt 0 uident, prt 0 lbracket, prt 0 mpltypes, prt 0 rbracket])
    MPL_UIDENT_SEQ_CONC_ARGS_TYPE uident lbracket mpltypes1 mpltypes2 rbracket -> prPrec i 2 (concatD [prt 0 uident, prt 0 lbracket, prt 0 mpltypes1, doc (showString "|"), prt 0 mpltypes2, prt 0 rbracket])
    MPL_UIDENT_NO_ARGS_TYPE uident -> prPrec i 2 (concatD [prt 0 uident])
    MPL_UNIT_TYPE lbracket rbracket -> prPrec i 2 (concatD [prt 0 lbracket, prt 0 rbracket])
    MPL_BRACKETED_TYPE lbracket mpltype rbracket -> prPrec i 2 (concatD [prt 0 lbracket, prt 0 mpltype, prt 0 rbracket])
    MPL_LIST_TYPE lsquarebracket mpltype rsquarebracket -> prPrec i 2 (concatD [prt 0 lsquarebracket, prt 0 mpltype, prt 0 rsquarebracket])
    MPL_TUPLE_TYPE lbracket mpltype tuplelisttypes rbracket -> prPrec i 2 (concatD [prt 0 lbracket, prt 0 mpltype, doc (showString ","), prt 0 tuplelisttypes, prt 0 rbracket])
    MPL_SEQ_ARROW_TYPE forallvarlists mpltypes mpltype -> prPrec i 2 (concatD [doc (showString "forall"), prt 0 forallvarlists, doc (showString "."), prt 0 mpltypes, doc (showString "->"), prt 0 mpltype])
    MPL_CONC_ARROW_TYPE forallvarlists mpltypes1 mpltypes2 mpltypes3 -> prPrec i 2 (concatD [doc (showString "forall"), prt 0 forallvarlists, doc (showString "."), prt 0 mpltypes1, doc (showString "|"), prt 0 mpltypes2, doc (showString "=>"), prt 0 mpltypes3])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
...
instance Print PlugPhrase where
  prt i e = case e of
    ...
    PLUG_PHRASE_AS pidents1 pidents2 processcommandsblock -> prPrec i 0 (concatD [prt 0 pidents1, doc (showString "=>"), prt 0 pidents2, doc (showString "->"), prt 0 processcommandsblock])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ";"), prt 0 xs])
