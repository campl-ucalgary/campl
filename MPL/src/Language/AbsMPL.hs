...
newtype Infix0op = Infix0op String
  deriving (Eq, Ord, Show, Read)

newtype Infix1op = Infix1op String
  deriving (Eq, Ord, Show, Read)

newtype Infix2op = Infix2op String
  deriving (Eq, Ord, Show, Read)

newtype Infix3op = Infix3op String
  deriving (Eq, Ord, Show, Read)

newtype Infix4op = Infix4op String
  deriving (Eq, Ord, Show, Read)

newtype Infix5op = Infix5op String
  deriving (Eq, Ord, Show, Read)

newtype Infix6op = Infix6op String
  deriving (Eq, Ord, Show, Read)

newtype Infix7op = Infix7op String
  deriving (Eq, Ord, Show, Read)
...
data FunctionDefn
    = FUNCTIONDEFNfull TokFun PIdent [Type] Type [PattTermPhrase]
    | FUNCTIONDEFNshort TokFun PIdent [PattTermPhrase]
  deriving (Eq, Ord, Show, Read)
...
data Term
    ...
    | CASETERM TokCase Term [PattTermPhrase]
...
data RacePart = RACEPART Channel Process
  deriving (Eq, Ord, Show, Read)
