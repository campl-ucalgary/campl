...
transStoreProc :: MplAsmLanguage.AbsMPLASM.StoreProc -> Result
transStoreProc x = case x of
  MplAsmLanguage.AbsMPLASM.StoreProc string -> failure x
...
transCom x = case x of
  ...
  MplAsmLanguage.AbsMPLASM.AC_STOREPROC storeproc pident -> failure x
