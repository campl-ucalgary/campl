...
instance Print MplAsmLanguage.AbsMPLASM.StoreProc where
  prt _ (MplAsmLanguage.AbsMPLASM.StoreProc (_,i)) = doc $ showString i
...
instance Print MplAsmLanguage.AbsMPLASM.Com where
  prt i = \case
    ...
    MplAsmLanguage.AbsMPLASM.AC_STOREPROC storeproc pident -> prPrec i 0 (concatD [prt 0 storeproc, prt 0 pident])
