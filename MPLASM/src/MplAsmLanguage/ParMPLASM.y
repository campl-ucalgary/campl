...
ListAmplConstructs : {- empty -} { [] }
                   | AmplConstructs ListAmplConstructs { (:) $1 $2 }

ProtocolCoprotocolSpec :: { MplAsmLanguage.AbsMPLASM.ProtocolCoprotocolSpec }
ProtocolCoprotocolSpec : UIdent '=' '{' ListHandle '}' { MplAsmLanguage.AbsMPLASM.PROTOCOL_COPROTOCOL_SPEC $1 $4 }
...
ListProtocolCoprotocolSpec : {- empty -} { [] }
...
Constructors : '%constructors' ':' '{' ListStructorSpec '}' { MplAsmLanguage.AbsMPLASM.CONSTRUCTORS $4 }

Destructors :: { MplAsmLanguage.AbsMPLASM.Destructors }
Destructors : '%destructors' ':' '{' ListStructorSpec '}' { MplAsmLanguage.AbsMPLASM.DESTRUCTORS $4 }

StructorSpec :: { MplAsmLanguage.AbsMPLASM.StructorSpec }
StructorSpec : UIdent '=' '{' ListStruct '}' { MplAsmLanguage.AbsMPLASM.STRUCT_SPEC $1 $4 }
...
Protocols : '%protocols' ':' '{' ListProtocolCoprotocolSpec '}' { MplAsmLanguage.AbsMPLASM.PROTOCOLS $4 }

Coprotocols :: { MplAsmLanguage.AbsMPLASM.Coprotocols }
Coprotocols : '%coprotocols' ':' '{' ListProtocolCoprotocolSpec '}' { MplAsmLanguage.AbsMPLASM.COPROTOCOLS $4 }

Processes :: { MplAsmLanguage.AbsMPLASM.Processes }
Processes : '%processes' ':' '{' ListProcessesSpec '}' { MplAsmLanguage.AbsMPLASM.PROCESSES $4 }

ListProcessesSpec :: { [MplAsmLanguage.AbsMPLASM.ProcessesSpec] }
ListProcessesSpec : {- empty -} { [] }
                  | ProcessesSpec { (:[]) $1 }
                  | ProcessesSpec ';' ListProcessesSpec { (:) $1 $3 }

ProcessesSpec :: { MplAsmLanguage.AbsMPLASM.ProcessesSpec }
ProcessesSpec : PIdent '(' ListPIdent '|' ListPIdent '=>' ListPIdent ')' '=' Coms { MplAsmLanguage.AbsMPLASM.PROCESS_SPEC $1 $3 $5 $7 $10 }
...
Functions : '%functions' ':' '{' ListFunctionsSpec '}' { MplAsmLanguage.AbsMPLASM.FUNCTIONS $4 }

ListFunctionsSpec :: { [MplAsmLanguage.AbsMPLASM.FunctionsSpec] }
ListFunctionsSpec : {- empty -} { [] }
                  | FunctionsSpec { (:[]) $1 }
                  | FunctionsSpec ';' ListFunctionsSpec { (:) $1 $3 }

FunctionsSpec :: { MplAsmLanguage.AbsMPLASM.FunctionsSpec }
FunctionsSpec : PIdent '(' ListPIdent ')' '=' Coms { MplAsmLanguage.AbsMPLASM.FUNCTION_SPEC $1 $3 $6 }

Main :: { MplAsmLanguage.AbsMPLASM.Main }
Main : Main_run MainChannels ':' Coms { MplAsmLanguage.AbsMPLASM.MAIN $1 $2 $4 }
     | {- empty -} { MplAsmLanguage.AbsMPLASM.NO_MAIN }

MainChannels :: { MplAsmLanguage.AbsMPLASM.MainChannels }
MainChannels : '(' '|' ListPIdent '=>' ListPIdent ')' { MplAsmLanguage.AbsMPLASM.MAIN_CHANNELS $3 $5 }
...
Com : PIdent ':=' Com { MplAsmLanguage.AbsMPLASM.AC_ASSIGN $1 $3 }
    ...
    | Plug ListPIdent 'as' '{' 'with' '[' ListPIdent ']' ':' Coms ';' 'with' '[' ListPIdent ']' ':' Coms '}' { MplAsmLanguage.AbsMPLASM.AC_PLUG $1 $2 $7 $10 $14 $17 }
...
LabelledComs : UIdent '.' UIdent ':' Coms { MplAsmLanguage.AbsMPLASM.AC_LABELLED_COMS_NO_ARGS $1 $3 $5 }
