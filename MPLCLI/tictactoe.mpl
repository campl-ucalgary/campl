...
fun showParsedGridIx :: Maybe(GridIx) -> [Char] =
    Just(_) -> "Just"
    Nothing -> "Nothing"
    ...
    | => passermem, usrmvset -> do
        ...
        if wonOrTie(grid)
            ...
            then do
                ...
                put (if winner(O, grid) then "You won!" else "You lost!", grid) on usrmvset
                close usrmvset
            ...
            PasserMem -> do
                ...
                if wonOrTie(grid)
                    then do
                        ...
                        hput UserMoveGameOver on usrmvset
                        put (if winner(X, grid) then "You won!" else "You lost!", grid) on usrmvset
                        close usrmvset
                        -}
