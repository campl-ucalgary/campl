...
--  •  Illegal `hput' command at line 22 and column 9. Expected output polarity channel

--         console

--     at line 22 and column 9 to have a `protocol' but got a `coprotocol' instead.
--  •  Illegal `hput' command at line 24 and column 9. Expected output polarity channel

--         console

--     at line 24 and column 9 to have a `protocol' but got a `coprotocol' instead.
