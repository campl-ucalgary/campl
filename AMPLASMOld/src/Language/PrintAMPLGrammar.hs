...
instance Print Language.AbsAMPLGrammar.IMPORTS where
  prt i e = case e of
    Language.AbsAMPLGrammar.Imports imports -> prPrec i 0 (concatD [prt 0 imports])

instance Print Language.AbsAMPLGrammar.LUIDENT where
  prt i e = case e of
    Language.AbsAMPLGrammar.LIDENT pident -> prPrec i 0 (concatD [prt 0 pident])
    Language.AbsAMPLGrammar.UIDENT uident -> prPrec i 0 (concatD [prt 0 uident])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString "/"), prt 0 xs]

instance Print Language.AbsAMPLGrammar.DirPath where
  prt i e = case e of
    Language.AbsAMPLGrammar.DIRPATH luidents -> prPrec i 0 (concatD [prt 0 luidents])

instance Print [Language.AbsAMPLGrammar.LUIDENT] where
  prt = prtList

instance Print Language.AbsAMPLGrammar.Slash where
  prt i e = case e of
    Language.AbsAMPLGrammar.SLASH -> prPrec i 0 (concatD [doc (showString "/")])
    Language.AbsAMPLGrammar.SLASH_NONE -> prPrec i 0 (concatD [])
...
instance Print Language.AbsAMPLGrammar.IMPORT where
  prt i e = case e of
    Language.AbsAMPLGrammar.Import slash dirpath -> prPrec i 0 (concatD [doc (showString "%include"), prt 0 slash, prt 0 dirpath, doc (showString ".ampl")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print Language.AbsAMPLGrammar.CHANNEL_SPEC where
  prt i e = case e of
    Language.AbsAMPLGrammar.Channel_specf pidents1 pidents2 -> prPrec i 0 (concatD [doc (showString "("), doc (showString "|"), prt 0 pidents1, doc (showString "=>"), prt 0 pidents2, doc (showString ")")])
    Language.AbsAMPLGrammar.Channel_spec cintegers1 cintegers2 -> prPrec i 0 (concatD [doc (showString "("), prt 0 cintegers1, doc (showString "=>"), prt 0 cintegers2, doc (showString ")")])
...
instance Print Language.AbsAMPLGrammar.COM where
  prt i e = case e of
    ...
    Language.AbsAMPLGrammar.AC_DESTl uident1 uident2 pident -> prPrec i 0 (concatD [prt 0 uident1, doc (showString "."), prt 0 uident2, prt 0 pident])
    Language.AbsAMPLGrammar.AC_DESTlas uident1 uident2 pidents pident -> prPrec i 0 (concatD [prt 0 uident1, doc (showString "."), prt 0 uident2, doc (showString "("), prt 0 pidents, doc (showString ")"), prt 0 pident])
    ...
    Language.AbsAMPLGrammar.AC_PUTf put pident -> prPrec i 0 (concatD [prt 0 put, prt 0 pident])
    ...
    Language.AbsAMPLGrammar.AC_PRODELEM cinteger pident -> prPrec i 0 (concatD [doc (showString "#"), prt 0 cinteger, doc (showString "("), prt 0 pident, doc (showString ")")])
